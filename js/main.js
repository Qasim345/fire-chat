...
function displayMessage(username, message, time, id) {
  ...
  if (username == $(".username").val()) {
    ...
    messageElement.innerHTML = `<div class="d-flex w-100 mb-2 justify-content-between align-items-center bg-secondary"><div class="d-flex align-items-center"><span class="ico h3"></span><b class="ml-2">${username}</b></div></div>`+`<p class="m-0 p-0 w-100">${message}</p><i>${time}</i>`;
  }
